...
const Services = () => {
  ...
  return (
    <div className={" w-full max-w-[1240px] mx-auto pb-[88px] text-white text-bodyText2 overflow-hidden"}>
        ...
        <div>
          <div className={"pb-[120px] flex max-md:flex-col-reverse max-md:center md:justify-between md:items-center md:gap-[60px] mt-[102px] max-md:text-bodyText1"}>
            <Lottie data-aos={"flip-right"} className={" w-full max-w-[749px] "} animationData={appLottie}/>
            <div data-aos={"fade-left"} className={"w-full max-w-[664px] text-white max-md:!text-center"}>
              <div
                className={"bg-[linear-gradient(90deg,#FFE943_0%,#CE9300_50%,#FFD60A_100%)] inline-block text-transparent bg-clip-text !text-h3 max-md:!mb-24"}>
                لورم ایپسوم ساختگی
              </div>
              <div className={""}>
      ...
      <div
        className={"pb-[120px] max-md:center flex max-md:flex-col md:justify-between items-center md:gap-x-[60px] max-md:text-bodyText1"}>
        <div data-aos={"fade-left"} className={" w-full max-w-[664px] text-white max-md:!text-center"}>
          <div
            className={"bg-[linear-gradient(90deg,#FFE943_0%,#CE9300_50%,#FFD60A_100%)] max-md:!mb-24 inline-block text-transparent bg-clip-text !text-h3"}>
            لورم ایپسوم ساختگی
          </div>
          <div className={""}>
      ...
      <div
        className={"pb-[120px] flex max-md:flex-col-reverse max-md:center md:justify-between md:items-center md:gap-[60px] max-md:text-bodyText1"}>
        <Lottie data-aos={"flip-right"} className={" w-full max-w-[749px] "} animationData={appLottie}/>
        <div data-aos={"flip-right"} className={" w-full max-w-[664px] text-white max-md:!text-center"}>
          <div
            className={"bg-[linear-gradient(90deg,#FFE943_0%,#CE9300_50%,#FFD60A_100%)] max-md:!mb-24 inline-block text-transparent bg-clip-text !text-h3"}>
            لورم ایپسوم ساختگی
          </div>
