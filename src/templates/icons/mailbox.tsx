...
const MailboxSvg = (props: TIconsSvgProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 36 36" fill="none">
    ...
    <path d="M26.25 12V6C26.25 4.34314 27.5931 3 29.25 3" stroke="#E7E7E7" stroke-width="1.5" stroke-linecap="round"
    ...
    <path
      ...
      stroke="#E7E7E7" stroke-width="1.5" stroke-linecap="round"/>
    <path
